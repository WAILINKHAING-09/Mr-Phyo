...
logo=(f"""
{W} _  _  ____     ____  _  _  _  _  __  
{G}( \/ )(  _ \   (  _ \/ )( \( \/ )/  \ 
{R}/ \/ \ )   / _  ) __/) __ ( )  /(  O )
{Y}\_)(_/(__\_)(_)(__)  \_)(_/(__/  \__/ 
""")
     ...
     try:
        ...
        for pswd in pp:
              ...
              if 6==random.randint(1,300):
                 oku.append(acc)
                 print('\033[1;32m[Mr-Phyo-OK] \033[1;32m'+acc+' \033[1;32m|\033[1;32m '+pswd)
                 open('/sdcard/Mr-Phyo-Ok.txt','a').write(f'{acc}|{pswd}\n')
                 break
              else:
                   continue   
